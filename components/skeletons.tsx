    ...
    return (
        <section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 md:grid-rows-2 gap-4 h-auto md:h-[500px]">
                {[0, 1, 2, 3, 4].map((i) => (
                    <div key={i} className={i === 0 ? 'col-span-2 row-span-2' : 'col-span-1 row-span-1'}>
...
/* ─── Grid of Manga Cards ─── */
export function MangaGridSkeleton({ count = 10, cols = 'grid-cols-2 md:grid-cols-4 lg:grid-cols-5' }: { count?: number; cols?: string }) {
    return (
