...
export function CommentsTable({ comments, loading, page, totalPages, onPageChange, onRefresh }: CommentsTableProps) {
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className="hidden md:block bg-[#0f0f0f] rounded-xl border border-white/5 overflow-hidden">
                        ...
                        {loading ? (
                            ...
                            comments.map((comment) => (
                                <tr key={comment.id} className="group hover:bg-white/[0.02] transition-colors">
                                    ...
                                    <td className="px-6 py-5 align-top">
                                        <div className="text-gray-300 text-[15px] leading-relaxed break-words pr-8">
                                            "{comment.content}"
                                        </div>
                                    </td>
                                    <td className="px-6 py-5 align-top">
                                        <div className="flex flex-col gap-2.5">
                                            ...
                                            >
                                                ...
                                                <span className="line-clamp-2 leading-snug">{comment.slug.replace(/-/g, ' ')}</span>
                                            </Link>
                                            ...
                                            {comment.chapter_slug && (
                                                <div className="flex items-center gap-2 pl-2">
                                                    ...
                                                    <Link
                                                        ...
                                                        target="_blank"
                                                        className="text-[11px] font-medium text-primary hover:text-primary/80 bg-primary/10 px-2 py-0.5 rounded border border-primary/20 transition-colors"
                                                    >
